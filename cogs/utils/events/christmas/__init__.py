...
class ChristmasEvent:
    def __init__(self, bot):
        ...
        self.activity = discord.Activity(name="Merry Christmas!! Ho Ho Ho!", type=discord.ActivityType.playing)
        ...
        self.start_time = datetime.datetime(year=2021, month=12, day=1, hour=0, minute=0, second=0, tzinfo=datetime.timezone.utc)
        self.end_time = datetime.datetime(year=2021, month=12, day=31, hour=23, minute=59, second=59, tzinfo=datetime.timezone.utc)
