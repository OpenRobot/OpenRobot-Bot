...
class RockPaperScissors:
    ...
    def get_winner(self):
        ...
        if self.player_one_option == self.player_two_option:
            ...
            self.player_one_option == Option.PAPER
            and self.player_two_option == Option.ROCK
        ):
            return Winner.PlayerOne
        elif (
            self.player_one_option == Option.SCISSORS
            and self.player_two_option == Option.PAPER
        ):
            return Winner.PlayerOne
        elif (
            self.player_one_option == Option.ROCK
            and self.player_two_option == Option.SCISSORS
        ):
            return Winner.PlayerOne
